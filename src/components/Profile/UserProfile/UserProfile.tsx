      ...
      <Grid container columnSpacing={2}>
        ...
        <Grid item md={6}>
          <FormControl fullWidth error={Boolean(formik.touched.email && formik.errors.email)} sx={{ ...theme.typography.customInput }}>
            <InputLabel htmlFor="outlined-adornment-email-login"> {`${intl.formatMessage({ id: 'email' })}`} </InputLabel>
            <OutlinedInput
        ...
        <Grid item md={6}>
          <FormControl
            ...
            sx={{ ...theme.typography.customInput }}
          >
            <InputLabel htmlFor="outlined-adornment-phoneNumber-login"> {`${intl.formatMessage({ id: 'phoneNumber' })}`} </InputLabel>
            <OutlinedInput
