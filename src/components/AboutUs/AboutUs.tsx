      ...
      <Grid container spacing={3}>
        <Grid item md={6}>
          <Box>
            ...
            <Box>
              ...
              >
                Với hơn 5 năm kinh nghiệm pick up store với hàng chục ngàn đơn hàng mỗi năm và vô vàn feedback, giao dịch legit check,
                Choose luôn cam kết uy tín và chất lượng sản phẩm mang đến cho mọi khách hàng 🌷.
              </Typography>
            </Box>
          </Box>
        </Grid>
        ...
        <Grid item md={6}>
          <Typography
            ...
            textAlign={'center'}
          >{`${intl.formatMessage({ id: 'contact-form' })}`}</Typography>
          <Box mt={5}>
