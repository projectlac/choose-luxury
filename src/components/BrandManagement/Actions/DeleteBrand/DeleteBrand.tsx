...
import { deleteBrand } from '../../../../../api/BrandAPI/brandAPI';
...
function DeleteBrand({ id, name }: IDeleteProps) {
  ...
  const deleteAction = async () => {
    ...
    try {
      ...
      dispatch(
        openSnackbar({
          open: true,
          message: `Delete Brand '${name}' Successful`,
          variant: 'alert',
  ...
  return (
    <>
      ...
      >
        ...
        <Divider />
        <DialogContent>{`Are you sure you want to delete the brand "${name}"?`}</DialogContent>
        <Divider />
        <DialogActions>
