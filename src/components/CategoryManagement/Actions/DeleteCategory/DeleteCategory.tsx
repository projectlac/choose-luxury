...
import { deleteCategory } from '../../../../../api/CategoryAPI/categoryAPI';
...
function DeleteCategory({ id, name }: IDeleteProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <Divider />
        <DialogContent>{`Are you sure you want to delete the category "${name}"?`}</DialogContent>
        <Divider />
        <DialogActions>
